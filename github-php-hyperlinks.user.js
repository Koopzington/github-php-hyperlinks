...
(function() {
    ...
    function grabFilesOnSameNamespace() {
        ...
        for (var ns in nsRoots) {
            if (currentNamespace.substring(0, nsRoots[ns].root.length) == nsRoots[ns].root) {
    ...
    function editDOM() {
        ...
        for (var j = 0; j < imports.length; ++j) {
            ...
            if (currentRoot !== undefined) {
                ...
                for (k = 0; k < toBeModified.length; ++k) {
                    toBeModified[k].innerHTML = '<a href="https://github.com/' + currentRoot.repo + '/tree/' + currentStatus + '/' + currentRoot.path + currentNamespace + '">' + toBeModified[k].innerHTML + '</a>';
                }
                ...
                for (k = 0; k < toBeModified.length; ++k) {
                    toBeModified[k].innerHTML = '<a href="https://github.com/' + currentRoot.repo + '/blob/' + currentStatus + '/' + currentRoot.path + currentNamespace + '/' + toBeModified[k].innerHTML + '.php">' + toBeModified[k].innerHTML + '</a>';
                }
                ...
                if (node !== null) {
                    ...
                    if (toBeModified.length > 0) {
                        node.innerHTML = '<a href="https://github.com/' + currentRoot.repo + '/tree/' + currentStatus + '/' + currentRoot.path + currentNamespace + '">' + node.innerHTML + '</a>';
                    } else {
                        node.innerHTML = '<a href="https://github.com/' + currentRoot.repo + '/blob/' + currentStatus + '/' + currentRoot.path + currentNamespace + '.php">' + node.innerHTML + '</a>';
                    }
                }
            }
        }
